    ...
    if (action === 'approve') {
      ...
      return new NextResponse(`
        <html><body style="font-family: sans-serif; padding: 40px; text-align: center;">
          ...
          <p>An approval email has been sent to ${company.email}.</p>
        </body></html>
        ...
        await resend.emails.send({
          ...
          html: `
            <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
              ...
              <p>If you believe this is an error, please contact us via the chat on our website.</p>
      ...
      return new NextResponse(`
        <html><body style="font-family: sans-serif; padding: 40px; text-align: center;">
          ...
          <p>A rejection email has been sent to ${company.email}.</p>
        </body></html>
      `, { headers: { 'Content-Type': 'text/html' } })
    }
